/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 773287eb04eecb7d740fa2a2a502cd80)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GAME_ROOM: DurableObjectNamespace<import("./workers/index").GameRoom>;
		WORKER_SELF_REFERENCE: Service<typeof import("./workers/index").default>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "DATABASE_URL" | "DIRECT_URL" | "SUPABASE_URL" | "SUPABASE_ANON_KEY">> {}
}
